export const heroOne = {
  ...
  imgStart: "start",
  img: process.env.PUBLIC_URL + "/images/content/rocket.svg",
...
export const heroTwo = {
  ...
  linkTo: "/more",
  imgStart: "start",
  img: process.env.PUBLIC_URL + "/images/content/landing-page.svg",
...
export const heroThree = {
  ...
  img: process.env.PUBLIC_URL + "/images/content/lost.svg",
  start: "true",
};
...
export const heroFour = {
  ...
  img: process.env.PUBLIC_URL + "/images/content/ecommerce.svg",
  start: "true",
};
